...
#All tokens
print(tk)
with open("/xampp/htdocs/laari/laari_wala/token_string.json","w") as w_file:
    json.dump(tk,w_file)
...
with open("/xampp/htdocs/laari/laari_wala/token_data_x.json","w") as w_file:
    json.dump(x_vals,w_file)

with open("/xampp/htdocs/laari/laari_wala/token_data_y.json","w") as w_file:
